	...
	public static class StringTableEntryDataFactory {
		...
		public static StringTableEntryData CreateData(SourceDemo demoRef, BitStreamReader bsr, string tableName, string entryName) {
			return tableName switch {
				"userinfo" => new PlayerInfo(demoRef, bsr, entryName),
				"server_query_info" => new QueryPort(demoRef, bsr, entryName),
				"instancebaseline" => new InstanceBaseLine(demoRef, bsr, entryName),
				"GameRulesCreation" => new GameRulesCreation(demoRef, bsr, entryName),
