...
namespace DemoParser.Parser.HelperClasses.EntityStuff {
	...
	public static class PropEnums {
		...
		public static readonly Collision_Group_t[] CollisionGroupListOldDemoProtocol = {
		...
		public static readonly Collision_Group_t[] CollisionGroupListNewDemoProcol = {
			COLLISION_GROUP_NONE,
			COLLISION_GROUP_DEBRIS,
			COLLISION_GROUP_DEBRIS_TRIGGER,
			COLLISION_GROUP_INTERACTIVE_DEBRIS,
		...
		public static readonly Collision_Group_t[] CollisionGroupListPortal2 = {
			COLLISION_GROUP_NONE,
			COLLISION_GROUP_DEBRIS,
			COLLISION_GROUP_DEBRIS_TRIGGER,
			COLLISION_GROUP_INTERACTIVE_DEBRIS,
		...
		// different enums for different versions, see below. these are also flags. todo if flags are only for player
